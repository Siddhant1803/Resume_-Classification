...
if menu_id == 'Home':
    ...
    with tab1:
        ...
        st.image("https://github.com/Siddhant1803/Resume_Classification/blob/main/Image/Designer.png?raw=true")
...
def extract_skills(resume_text):
    ...
    data = pd.read_csv("https://github.com/Siddhant1803/Resume_Classification/blob/main/Resume.csv",encoding='cp1252') 
